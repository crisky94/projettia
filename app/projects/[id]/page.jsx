                    ...
                    <div className="flex items-center justify-between w-full">
                        ...
                        {canManageMembers && (
                            <button
                                ...
                                className="h-14 w-14 flex items-center justify-center rounded-xl bg-white/10 hover:bg-primary/20 text-white/70 hover:text-primary transition-all duration-300 border border-white/20 hover-lift shadow-2xl group"
                                title="Edit Project Settings"
                            >
                                <svg className="w-12 h-12 group-hover:rotate-90 transition-transform duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
